...
public class StudentRegisterManager {
    ...
    public void studentRegister() throws Exception {
        ...
        do {
            ...
            id_check = sao.getStudentIdOverlap(sd_id);
            if (id_check) {
        ...
        // 학생 번호는 8자리로 생성한다. (연도2자리+학과2자리+일련번호 - 예로 06010001)
        SimpleDateFormat sdf = new SimpleDateFormat("yy");
        year = sdf.format(new Date());
        sd_num = year + s_num + sao.getStudentCount(s_num);
        ...
        sao.setStudentRegister(svo);

        System.out.println();
        System.out.println("등록 학생 정보");
        sao.getStudent(svo.getSd_id(), svo.getSd_passwd());
        System.out.println();
    }
    ...
    public void studentUpdate() throws Exception {
        ...
        do {
            ...
            if (!success) {
                System.out.println("아이디 또는 비밀번호가 틀립니다. 다시 입력");
            }
        } while (!success);
