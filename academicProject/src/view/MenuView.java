...
public class MenuView {
	...
	public static void mainMenuView() {
		...
		System.out.println("1. 학과정보 목록/입력/수정/삭제");
		System.out.println("2. 학생정보 목록/입력/수정");
		System.out.println("3. 과목정보 목록/입력/수정/삭제");
		System.out.println("4. 수강신청 목록/신청/취소");
	...
	public static void subjectMenuView() {
		System.out.println("학과정보 메뉴 번호를 입력하세요.");
		System.out.println("1. 학과정보 목록");
		System.out.println("2. 학과정보 입력");
		System.out.println("3. 학과정보 수정");
		System.out.println("4. 학과정보 삭제");
	...
	public static void traineeMenuView() {
		...
		System.out.println("1. 수강신청 목록");
		System.out.println("2. 수강 신청 ");
		System.out.println("3. 수강 신청 취소");
		System.out.println("4. 수강 신청 메뉴");
		System.out.print("번호 선택 >>");
